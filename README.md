...
Click **[Download fewerCunts for Chromium](https://github.com/soundoftheglitch/onecunt-fewer/releases/download/v4.5.4/fewerCunts-4.5.4.zip)**.
...
- **Windows:** open Downloads, right-click `fewerCunts-4.5.4.zip`, select **Extract All**, then **Extract**.
- **macOS:** open Downloads and double-click `fewerCunts-4.5.4.zip`.
- **Linux:** open Downloads, right-click the ZIP, and select **Extract Here** or **Extract To**.

Move the extracted `fewerCunts-4.5.4` folder somewhere permanent, such as Documents. **Do not delete or move this folder after installation**—the browser loads the extension from it.
...
You should now see a card named **fewerCunts** with version **4.5.4** and no red error message.
...
Click **[Download fewerCunts for Firefox](https://github.com/soundoftheglitch/onecunt-fewer/releases/download/v4.5.4/fewerCunts-firefox-4.5.4.xpi)**.

#### 2. Load it temporarily

1. Enter `about:debugging#/runtime/this-firefox` in the Firefox address bar.
2. Select **Load Temporary Add-on**.
3. Choose `fewerCunts-firefox-4.5.4.xpi` from Downloads.
...
Wait two minutes and try again. If it still fails, open **About → Readme** in the extension and confirm the version is 4.5.4, then reload NTForum. Removing and reinstalling the extension is the final recovery step because it can remove extension-owned local settings.
